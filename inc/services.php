...
function create_service_cpt() {
	...
	$labels = array(
		'name' => __( 'Services', 'Post Type General Name', 'wplearning' ),
		'singular_name' => __( 'Service', 'Post Type Singular Name', 'wplearning' ),
		'menu_name' => __( 'Services', 'wplearning' ),
		'name_admin_bar' => __( 'Service', 'wplearning' ),
